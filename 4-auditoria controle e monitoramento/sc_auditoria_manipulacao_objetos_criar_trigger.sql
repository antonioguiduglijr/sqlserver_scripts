--http://www.dirceuresende.com/blog/como-criar-uma-trigger-de-auditoria-para-logar-a-manipulacao-de-objetos-no-sql-server/
--trigger de Auditoria para logar a manipulação de objetos no SQL Server
